...
public class Messenger {
         ...
         while(keepon) {
            ...
            if (authorisedUser != null) {
              ...
              while(usermenu) {
                ...
                System.out.println("3. Delete someone from your contact list");
                System.out.println(".........................");
                
                System.out.println("4. Add to block list");
                System.out.println("5. Browse block list");
                System.out.println("6. Delete someone from your block list");    
                System.out.println(".........................");
                
                System.out.println("7. Browse current chat lists");
                System.out.println("8. Start new chat"); // add members
                                                         // A new chat should appear in user’s chat list whenever 
                                                         // he becomes a new member of the chat.
                System.out.println("9. Manage chatting members"); // delete(1)/add(2) chatting members ONLY by initial creater,
                                                                  // use another memu here! 
                System.out.println("10. Delete my chats"); // ONLY initial creater
                System.out.println("11. Browse chat messages");
                System.out.println(".........................");
                
                System.out.println("12. Write a new message");
                System.out.println('13. Edit a message');
                System.out.println("14. Delete chat messages");  // only those user wrote
                System.out.println(".........................");
                
                System.out.println("15. Delete my accout");
                System.out.println(".........................");
   ...
   public static void AddToContact(Messenger esql){
      ...
      /*
      try{
         String query = "SELECT Suppliers.sname, COUNT(Catalog.pid) FROM Suppliers, Catalog WHERE Suppliers.sid = Catalog.sid GROUP BY Suppliers.sname HAVING COUNT(Catalog.pid) > 2 ";
