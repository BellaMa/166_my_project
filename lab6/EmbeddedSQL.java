...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
       try{
         String query = "SELECT Suppliers.sname, COUNT(Catalog.pid) FROM Suppliers, Catalog WHERE Suppliers.sid = Catalog.sid GROUP BY Suppliers.sname ";
   ...
   public static void Query4(EmbeddedSQL esql){
     try{
         String query = "SELECT S.sname, MAX(C.cost) as Maxvalue FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND C.sid = S.sid AND  ( P.color='Green') and ( P.color='Red') group by S.sname ";
   ...
   public static void Query6(EmbeddedSQL esql){
      ...
      // ...
      try{
        String query = "SELECT Suppliers.address FROM Catalog, Parts, Suppliers WHERE Catalog.pid = Parts.pid AND Catalog.sid = Suppliers.sid AND Parts.pname = \'";
       System.out.print("\tEnter cost: $");
       String input = in.readLine();
       query += input;
       query += "\'";
